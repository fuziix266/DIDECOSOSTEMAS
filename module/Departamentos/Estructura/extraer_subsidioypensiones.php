<?php
/**
 * Extraer y actualizar datos de trámites de Subsidios y Pensiones
 */
...
try {
    ...
    $viewsPath = __DIR__ . '/../view/departamentos/subsidioypensiones/';
    $files = glob($viewsPath . '*.phtml');
    
    $departamentoId = 5; // Subsidios y Pensiones
    $tramitesData = [];
