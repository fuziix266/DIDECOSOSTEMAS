<?php
/**
 * Extraer y actualizar datos de trámites de ODIMA
 */
...
try {
    ...
    $departamentoId = 8; // Servicios para Pueblos Indígenas (ODIMA)
    $tramitesData = [];
    ...
    foreach ($files as $file) {
        ...
        // Extraer documentos requeridos (accordion-body o card-body)
