<?php
/**
 * Convertir vistas de Juventud al sistema dinámico
 */

$viewsPath = __DIR__ . '/../view/departamentos/juventud/';
...
echo $this->render(\'departamentos/juventud/_tramite_detalle\', [\'tramite\' => $tramite]);
';
