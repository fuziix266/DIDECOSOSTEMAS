<?php
/**
 * Convertir vistas de OLN al sistema dinámico
 */

$viewsPath = __DIR__ . '/../view/departamentos/oln/';
...
echo $this->render(\'departamentos/oln/_tramite_detalle\', [\'tramite\' => $tramite]);
';
